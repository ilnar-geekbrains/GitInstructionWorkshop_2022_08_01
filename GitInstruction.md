...
Система контроля версий нужна для того, чтобы в случае возникновения ошибок, можно было вернуться к рабочей версии проекта, а также для более удобной совместной работы над проектом
