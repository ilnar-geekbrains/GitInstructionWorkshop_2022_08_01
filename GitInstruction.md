...
Чтобы создать ветку необходимо воспользоваться командой git branch название ветки. Чтобы перейти с ветки на ветку нужно воспользоваться командой git checkout имя ветки. Вывести все ветки на экран git branch. Создать ветку и перейти на нее git checkout -b имя ветки.
