...
Ветки - это версии файла, которые существуют и можно изменять независимо друг от друга до момента слияния их друг с другом с помощью команды "git merge". Ветки нужны,чтобы команда разработчиков вела в них работу по различным разделам проекта, не изменяя основную ветку проекта (чистовик)
