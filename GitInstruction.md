...
### Что такое ветки и для чего они нужны при работе с системой контроля версий.
    ...
    Ветки - это метки на коммитах, созданные для нашего удобства. Требуются они что бы удобнее перемещаться между коммитами, не терять их. Также ветки нужны для редактирования файла, их можно использовать как черновик. Все изменения из "черновых" веток можно слить в матер ветку либо таг.
