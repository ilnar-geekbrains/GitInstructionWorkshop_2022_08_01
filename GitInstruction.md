...
Для того что бы создать ветку в вашем репозитории нужно написать команду:

        git branch "branch_name"

Для того что бы перейдти в нужную ветку используем команду:

        git checkout "branch_name"

Для того что бы совместить нужную ветку с веткой "master" используем команду:
