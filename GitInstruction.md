...
1. ***Посмотреть список веток в репозитории***
...
Чтобы создать ветку и сразу в нее перейти (копируетс ветка в которой находимся), используем команду:

> git checkout -b <название ветки>

5. ***Удалить ветку***

Проерит "можно ли смержить ветку"

> git branch -d <название ветки>

Удаление без проверки на merge:
