...
1. Чтобы создать ветку нужно выполнить команду git branch branch_name
2. Чтобы посмотреть какаие ветки есть пишем команду git branch
3. Чтобы слить ветки нужно выполнить команду git merge branch_name
4. Чтобы удалить ветку нужно выпонить команду git  branch name -d
