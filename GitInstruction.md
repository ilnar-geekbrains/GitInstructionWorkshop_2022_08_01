...
Недостатки: 
        ...
        1. Переименование или перемещение файлов не отражается в истории
        2. Риски безопасности, связанные с символическими ссылками на файлы
        3. Нет поддержки атомарных операций, что может привести к повреждению кода
        4. Операции с ветками программного кода дорогостоящие, так как эта система контроля не       предназначена для долгосрочных проектов с ветками кода

#### **Mercurial** 

Преимущества:

        1. По сравнению с Git легче в освоении 
        2. Подробная документация 
        3. Распределенная модель системы контроля версий

Недостатки: 

        1. Нет возможности слияния двух родительских веток
        2. Использование плагинов, а не скриптов
        3. Меньше возможностей для нестандартных решений
