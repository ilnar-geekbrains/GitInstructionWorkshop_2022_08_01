...
> Ветки - отдельные версии файлов в гите, где можно вносить изменения без имзменения главного файла

> Нужны для командной работы, либо для тестовых работ с изменением кучи файлов (текст, код и прочее)
