...
git branch - показывает где мы сейчас находимся - на какой ветке

git branch <название новой ветки> - создание новой ветки 

git merge <имя ветки для слияния>- команда для слияния любой ветки с текущей

git branch -d <имя ветки для удаления> - команда для удаления ненужных веток

git ignore - исключение ненужных файлов из загрузки (папка в которой можно записать названия файлов которые будут исключены)

git log—graph - позволяет отобразить комиты в виде дерева(визуализация)
