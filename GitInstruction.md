...
Репозиторий — хранилище файлов и других данных, поддерживающий версионность. Как правило используется для распространения данных в сети Интернет.
Чтобы создать локальный репозиторий нужно прописать в терминале git init
