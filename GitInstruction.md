...
Ветри нужны чтобы разделять код. Это дает нам возможность легко откатывать код, если вдруг мы передумаем его сливать в основнную ветку.Чтобы посмотреть на какой ветке мы находимся нужно в терминале набрать команду:

        git branch

Для перемещения поветкам набирам команду:
