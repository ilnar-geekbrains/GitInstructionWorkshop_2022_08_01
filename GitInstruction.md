...
1. Находим пенсионерку, которая может пользоваться компьютером.
2. Создаем Яндекс.Диск
3. Скидываем ей файлы.
4. Идет сравнение файлов.
5. Пенсионерка выдает файлы.
