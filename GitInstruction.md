...
Команды git с ветками:

1. git branch - выводим списое веток в репозитории.

2. git branch new_name - создаем новую ветку с именем new_name.

3. git branch -d new_name - удаляем ветку с именем new_name.

4. git checkout branch_name - переходим на ветку branch_name.

5. git log -graph - выводим список коммитов в виде красивого дерева.

6. git merge branch_name - сливаем ветку branch_name с текущей веткой.

7. git checkout -b branch_name - создаем и переходим к ветке branch_name одной командой.
