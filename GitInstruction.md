...
## Приложение LearnGitBranching.

*Это приложение создано, чтобы помочь новичкам постичь мощные возможности ветвления и работы с git, это приложение игра и может вы что-то усвоите!* <https://learngitbranching.js.org/?locale=ru_RU>
