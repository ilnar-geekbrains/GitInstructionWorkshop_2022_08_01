...
* Это версия репозитория которая находится в сети ,например на сайте [GitHub](https://github.com/)
* Она необходима для того чтобы ей можно было легко поделиться с коллегами или для того чтобы работадатель смог увидеть что ты умеешь.
